...
import com.madalin.notelo.component.AppProgressDialog
...
class SignUpViewModel(
     ...
     */
    private fun handleAccountCreationFailure(failureType: SignUpFailure) {
        when (failureType) {
