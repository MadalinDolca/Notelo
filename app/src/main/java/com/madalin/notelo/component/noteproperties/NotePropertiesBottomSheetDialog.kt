package com.madalin.notelo.component.noteproperties
...
import com.madalin.notelo.feature.notesandcategories.noteviewer.NoteViewerFragment
...
class NotePropertiesBottomSheetDialog(
    ...
    private fun populateCategoriesSpinner() {
        repository.getCategoriesByUserId(UserData.currentUser.id,
