...
data class Category(
    ...
    companion object {
        ...
        val NAME_UNCATEGORIZED = ApplicationClass.context.getString(R.string.uncategorized) // used as the name for the category that contains the uncategorized notes
